...
- Parte superior da janela, o sistema mostrará um formulário onde o usuário digita os limites de tempo, variável meteorológica e ponto de monitoramento.

- Abaixo do formulario um gráfico dinâmico onde o sistema irá oferçer ao uusuário, a direção dos ventos, velocidade e rajadas; junto ao intervalo de tempo submetido no formulário.
...
- O sistema também dará a opção de baixar uma tabela com os dados submetidos no formulário e ser exportável para CSV, PDF e PNG.
